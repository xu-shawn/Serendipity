...
public class Bitboard
{
	 ...
	 * attacked by a white pawn placed at square {@code A2} (index 8), bitboard at
	...
	final static long[] whitePawnAttacks = { 0x0000000000000200L, 0x0000000000000500L, 0x0000000000000a00L,
			...
			0x0000000000000000L };
	/**
	 * The bitboards representing the squares attacked by a black pawn placed in any
	 * given square on the board. Bitboard at index 48 identifies the squares
	 * attacked by a black pawn placed at square {@code A7} (index 48), bitboard at
	...
	final static long[] blackPawnAttacks = { 0x0000000000000000L, 0x0000000000000000L, 0x0000000000000000L,
			...
			0x0040000000000000L };
	/**
	 * The bitboards representing the squares a white pawn can move to from any
	 * given square on the board. Bitboard at index 8 identifies the squares a white
	 * pawn can reach from square {@code A2} (index 8), bitboard at index 9 the
	...
	final static long[] whitePawnMoves = { 0x0000000000000100L, 0x0000000000000200L, 0x0000000000000400L,
			...
			0x0000000000000000L };
	/**
	 * The bitboards representing the squares a black pawn can move to from any
	 * given square on the board. Bitboard at index 48 identifies the squares a
	 * black pawn can reach from square {@code A7} (index 48), bitboard at index 49
	...
	final static long[] blackPawnMoves = { 0x0000000000000000L, 0x0000000000000000L, 0x0000000000000000L,
			...
			0x0080000000000000L };
	/**
	 * The bitboards representing the adjacent squares of any given square on the
	 * board. For instance, bitboard at index 0 identifies the squares {@code B1},
	 * {@code A2} and {@code B2}, adjacent to square {@code A1}, identified by index
	 * 0.
	 */
